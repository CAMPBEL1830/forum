...
<body id="particles-js">
        ...
        <div class="card-body">
            <div class="login-wrap">
                <div class="login-html">
                    ...
                    <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Connecter</label>
                    <div class="login-form">
                        ...
                        <form action="registration.php" method="POST">
                            <div class="sign-up-htm">
                                ...
                                <div class="group">
                                    <label for="user" class="label">Nom et prénoms</label>
                                    <input id="user" type="text" class="input" name="name" required>
                                    <label for="user" class="label">Masculin : <input id="user" type="radio" value="Masculin"  name="gender" checked>Féminin : <input id="user" value="Feminin" type="radio"  name="gender"></label>
                                ...
                                <div class="group">
                                    <label for="pass" class="label">Numéro</label>
                                ...
                                <div class="hr"></div>
                                <div class="foot-lnk">
                                    <label for="tab-1">Etes-vous déjà une membre ?</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div id="webtitle">
        <div class="card-body">
            <h1 class="card-title text-center">Tech-Talk Forum <br> <span style="Font-size:0.14in;"><small>Forum de discussion MBDS-ESATIC</small></span>  </h1>
        </div>
    </div>
