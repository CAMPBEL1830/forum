...
function Header()
{
    ...
    $this->Cell(60);
    // Title
    $this->Cell(80,10,'Liste des utilisateurs',1,0,'C');
    // Line break
    $this->Ln(20);
}
...
$display_heading = array('userid'=>'Identifiant', 'name'=> 'Nom et prenoms','password'=> 'Mot de passe', 'email'=> 'E-mail','mobile'=> 'Numero','gender'=> 'Genre');
...
$pdf->Cell(0,10,"Nombre total d'utilisateur : ".$c[0]);
$pdf->Ln();
