...
<body>
    ...
    <div>
        <div align="center">
        <p></p>
           <h4>Nom d'utilisateur: <?php echo $full_name; ?></h4>
            <form action="update_name.php" method="post">
                <b>Changer le nom d'utilisateur:</b> <input type="text" name="name" placeholder="<?php echo "Nom"; ?>"
                    required />
                <button type="submit" value="submit" class="btn btn-danger">Changer</button><br><br>
            </form>
            <p></p>
           
            <h4>Ancien mot de passe: <?php echo "******"; ?></h4>
            <form action="update_password.php" method="post"><b>Entrer un nouveau mot de passe:</b> <input type="password"
                    name="password" data-type="password" placeholder="<?php echo "Mot de passe"; ?>" required />
                <button type="submit" value="submit" class="btn btn-danger">Mettre à jour</button><br><br>
            </form>
            <p></p>
            <h4> Numéro de télephone primaire : +225 <?php echo $mobile; ?></h4>
            <form action="update_mobile.php" method="post"><b>Entrer un nouveau numéro:</b> <input type="text" name="Numéro"
                    placeholder="<?php echo "Numéro de téléphone"; ?>" required />
                <button type="submit" value="submit" class="btn btn-danger">Changer</button><br><br>
            </form>
        </div>
    </div>
