...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="headerWrapper">
        <div class="container">
            <a class="navbar-brand" href="home.php">Teck-Talk Forum</a>
    ...
    <div>
        <div class="container mt-3">
            ...
            <img src="../img_avatar.png" alt="Card image" style="width:15%">
                ...
                <p class="card-text"><b>Genre:</b> <?php echo $gender; ?><br></p>
                <p class="card-text"> <b>Email:</b> <?php echo $email; ?><br></p>
                <p class="card-text"><b>Mot de passe:</b> <?php echo $password; ?><br></p>
                <p class="card-text"><b>Numéro de téléphone:</b> <?php echo $mobile; ?><br></p>
                <a href="setting.php" class="btn btn-primary">Editer le Profil</a>
            </div>
        </div>
    </div>
    <div>
