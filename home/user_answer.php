                    ...
                    <?php
                        ...
                        while($a=mysqli_fetch_array($ans))
                        {
                            ...
                            while($q=mysqli_fetch_array($ques)){
                                ...
                                print ("<div class='right'><small style='color:blue; font-size:0.13in;'><i>Posté le : " . $date->format('d F Y') . "</i></small></h4><br/>");
                                print ("<b><u>Sujet :</u></b> <i>".$q['question']."</i><br/>");
                                print ("Votre réponse<b></b> : <i>".$a['answer']."</i></div>");
